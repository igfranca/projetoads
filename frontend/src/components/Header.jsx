  ...
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
        ...
        <div className='flex items-center rounded-full border border-gray-300 pr-4 pl-6 py-2 shadow-md'>
        ...
        <div className='flex items-center rounded-full border border-gray-300 pr-4 pl-6 py-2 shadow-md gap-2'>
